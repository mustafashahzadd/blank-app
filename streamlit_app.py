...
# @st.cache(allow_output_mutation=True)
    def load_data():
        try:
            with open(r"C:\\Users\\musta\\blank-app\\output_file1.json", 'r', encoding='utf-8-sig') as file:
                data = json.load(file)
                return data
...
def med_app():
    ...
    def load_data():
        try:
            with open(r"C:\\Users\\musta\\blank-app\\otraining1.json", 'r', encoding='utf-8') as file:
                data = json.load(file)
                return data
        except FileNotFoundError:
